...
export const CopyEmail = ({
  ...
  const email = "hello@luminousdigital.studio";
  ...
  return (
    <div className={classNames("copy-email-wrapper")}>
      <div
        className={classNames("copy-email", size, {"hovered": isHovered})}
      ...
      >
        ...
        <button
          className={classNames("copy-email__button", "u-pad-xs", "u-font-display", "u-fontsize-0", size,
            {
        ...
        >
          ...
          <span className={classNames("label")}>{isCopied ? "All yours!" : "Copy email"}</span>
        </button>
      </div>
    </div>
  );
