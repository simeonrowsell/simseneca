...
export const LargeEmail = ({
  ...
  return (
    <>
      <div
        className={classNames("large-email")}
      ...
      {isCopied && (
        <div className={classNames("copied-email-toast")}>
          <span className={classNames("copied-email-toast__email", "u-font-display")}>sim@simseneca.design</span> 
