  ...
  return (
    <section class={`receipt-section${sectionState !== "idle" ? ` receipt-section--${sectionState}` : ""}`}>
      ...
      <div class="receipt-section__header">
        ...
        <p class="receipt-description">Whatever you write will be instantly printed on the receipt printer sitting on my desk. It's completely anonymous, just a digital to physical connection between one human being and another.</p>
      ...
      <div class="receipt-section__form">
        ...
        />
        <p>Max 50 characters, standard ASCII (the printer's not too smart)</p> 
      </div>
